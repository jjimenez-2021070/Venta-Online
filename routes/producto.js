...
//Controllers
const { getProductosMasComprados,postProducto, putProducto, deleteProducto, getProductos, getProductoPorId } = require('../controllers/producto');
...
router.get('/mascomprados', getProductosMasComprados);
